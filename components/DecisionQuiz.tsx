  ...
  const getRecommendations = (): Recommendation[] => {
    ...
    if (answers.revenue === 'over40') {
      recs.push({
        ...
        urgency: 'critical',
        reason: 'Mandatory by law - ₹25K penalty + jail risk',
        cost: 2999
      });
    }
    ...
    if (answers.timeline === 'immediate' || answers.funding === 'yes') {
      recs.push({
        ...
        urgency: 'high',
        reason: 'Required for funding, protects personal assets',
        cost: 12999
      });
    }
    ...
    if (answers.employees === 'planning') {
      recs.push({
        ...
        urgency: 'high',
        reason: 'Required for company registration and GST',
        cost: 999
      });
    }
    ...
    recs.push({
      ...
      urgency: 'medium',
      reason: 'Protects your brand from copycats',
      cost: 5999
    });
    ...
    return (
      <section className="section bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        <div className="container mx-auto px-6 max-w-4xl">
              ...
              <div key={timing} className="mb-12">
                <h3 className="text-2xl font-bold mb-6 flex items-center gap-3">
                  <span className="text-3xl">
                    {timing.includes('Immediate') ? '🔥' : timing.includes('1 Month') ? '📅' : '🎯'}
                  </span>
                  {timing}
                </h3>
                      ...
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            >
                              {urgencyEmojis[rec.urgency]} {rec.urgency.toUpperCase()}
                            </span>
                          </div>
                          <p className="text-gray-700 leading-relaxed">{rec.reason}</p>
                        </div>
                        <div className="text-right">
                          <div className="text-3xl font-extrabold bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent">
          ...
          <div className="card-premium bg-gradient-to-r from-blue-600 to-green-600 text-white text-center">
            <div className="text-lg mb-2 opacity-90">Total Estimated Investment</div>
            <div className="text-6xl font-extrabold mb-4">₹{totalCost.toLocaleString('en-IN')}</div>
            <div className="text-sm opacity-90">
              Includes government fees + professional charges
            </div>
          </div>
      ...
      <div className="container mx-auto px-6 max-w-3xl">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            Answer 4 simple questions to get your personalized registration plan
          </p>
        </div>
        ...
        <div className="card-premium">
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { value: 'under40', label: '< ₹40 Lakhs' },
                { value: 'over40', label: '> ₹40 Lakhs' }
              ].map((option) => (
                <button
                  key={option.value}
